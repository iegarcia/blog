            ...
            <tbody>
              @foreach ($cats as $cat)
                <tr>
                  <td>{{$cat->id}}</td>
                  <td>{{$cat->name}}</td>
                  <td width="10px"><a href="{{ route('categories.show', $cat->id)}}" class="btn btn-sm btn-success">Ver</a></td>
                  <td width="10px"><a href="{{ route('categories.edit', $cat->id)}}" class="btn btn-sm btn-secondary">Editar</a></td>
                  <td width="10px">
